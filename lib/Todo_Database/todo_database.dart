...
class DatabaseHelper {
	...
	void _createDb(Database db, int newVersion) async {
		...
		await db.execute('CREATE TABLE $todoTable($colId INTEGER PRIMARY KEY AUTOINCREMENT, $colItemname TEXT, '
	...
	Future<List<Map<String, dynamic>>> getTodoMapList() async {
		...
		var result = await db.query(todoTable, orderBy: '$colItemname ASC');
		return result;
	}
